...
|:-:|-----------|:------:|---------|-----------|--------------|
| 0 | Ecosystem setup | 🟡 In progress | 2026-06-26 | — | this repo |
| 1 | LLM fundamentals & prompt engineering | ⚪ Not started | — | — | `structured-extractor` |
...
*None yet — first project lands in Milestone 1.*
